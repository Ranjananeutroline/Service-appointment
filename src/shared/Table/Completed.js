...
function Total() {
  ...
  // // const newData = {...allAppointments.data};
  // // console.log(newData);
  // console.log('new all appoointments', allAppointments);
  ...
  // });
  // console.log('filtered appoointments',filteredAppointments);
  ...
  //   name: item.fullname,
  //   email: item.email,
  //   contact: item.phonenumber.toString(), // Convert the number to a string
  //   date: item.date,
  ...
  //       dispatch(getAllAppointments());
  //       console.log(allAppointments);
  //       filterAppointmentfunction();
  //     };
  //   }, [dispatch]);
  //   const filterAppointmentfunction =()=>{
  //     console.log('k bho malai');
  //     const currentDate = new Date();
  //     const filteredAppointments = allAppointments.filter((item) => {
  //       const appointmentDate = new Date(item.date);
  //       return appointmentDate <= currentDate;
      ...
      <table className="w-[800px] md:w-full h-full">
        ...
        <tbody>
          {data?.map((item) => (
            <tr
              key={item.id}
              className={`border h-[50%] text-[16px] md:text-[16px] md:h-[60px] ${item.status=== "Completed"} ? `}
            >
              ...
              <td className="  flex gap-2 flex-col md:flex-row justify-center items-center    md:h-[60px] ">
                ...
                <Modal
                  ...
                  center
                >
                  <div className=" w-[300px]  flex flex-col justify-center items-start gap-8 bg-[#ffffff] p-2">
                    <div>
