...
export const DeactivateAccount = ({
  ...
  const handleDeactivateAccount = async() => {
    ...
    const response = await axios.post("http://www.localhost:8000/api/auth/deactivateaccount",{email})
  ...
  return (
    <div>
      <Modal
        ...
        center
      >
        <div className=" w-full p-5 sm:px-10 md:w-[500px]  flex flex-col justify-center items-start gap-5 bg-[#FFFFFF]">
          <div>
