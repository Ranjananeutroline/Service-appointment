...
const SidebarForMobile = () => {
  ...
  return (
    <div className="">
      <div
        className="absolute top-[50%] block lg:hidden cursor-pointer h-[30px] w-[30px] md:h-[40px] z-20 md:w-[40px]"
  ...
  <path strokeLinecap="round" strokeLinejoin="round" d="M8.25 4.5l7.5 7.5-7.5 7.5" />
      ...
      {profileDropDown && (
        <div className="absolute top-[40%] z-50 dropdown-content flex flex-col bg-[#F6F8FC] px-2 py-1  shadow-lg  transition duration-200">
          <div
            className={` ${
