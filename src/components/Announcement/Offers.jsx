        ...
        >
          ...
          <div className="flex w-full px-4 py-[17px] gap-3  items-center  second-div-offer">
            <img
              src={radio}
              alt="radio"
              className="w-[12x] h-[12px] mb-[20px]"
            />
            ...
            <div className="edit-trash-container mr-5">
              <div className="flex  items-center justify-end  offer-edit-r">
                <div className="flex gap-3">
                  <img src={edit}  onClick={() => openModal(offer)} alt="edit" className="w-[15px] h-[15px]" />
                  <img src={trash} onClick={()=>handleOfferDeleteModal(offer)} alt="trash" className="w-[14px] h-[16px]" />
                </div>
              </div>
            </div>
          </div>
